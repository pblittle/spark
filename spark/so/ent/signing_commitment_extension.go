...
// GetUnusedSigningCommitments gets unused signing commitments from the database.
...
func GetUnusedSigningCommitments(ctx context.Context, dbTx *Tx, count uint32, operatorIndex uint) ([]*SigningCommitment, error) {
