...
type EntityDkgKeyFunc func(context.Context, *ent.EntityDkgKeyQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f EntityDkgKeyFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.EntityDkgKeyQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.EntityDkgKeyQuery", q)
}

// The TraverseEntityDkgKey type is an adapter to allow the use of ordinary function as Traverser.
type TraverseEntityDkgKey func(context.Context, *ent.EntityDkgKeyQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseEntityDkgKey) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseEntityDkgKey) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.EntityDkgKeyQuery); ok {
		return f(ctx, q)
	}
...
// Query calls f(ctx, q).
func (f L1TokenCreateFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.L1TokenCreateQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.L1TokenCreateQuery", q)
}

// The TraverseL1TokenCreate type is an adapter to allow the use of ordinary function as Traverser.
type TraverseL1TokenCreate func(context.Context, *ent.L1TokenCreateQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseL1TokenCreate) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseL1TokenCreate) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.L1TokenCreateQuery); ok {
		return f(ctx, q)
	}
...
// The SparkInvoiceFunc type is an adapter to allow the use of ordinary function as a Querier.
type SparkInvoiceFunc func(context.Context, *ent.SparkInvoiceQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SparkInvoiceFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SparkInvoiceQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SparkInvoiceQuery", q)
}

// The TraverseSparkInvoice type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSparkInvoice func(context.Context, *ent.SparkInvoiceQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSparkInvoice) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSparkInvoice) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SparkInvoiceQuery); ok {
		return f(ctx, q)
	}
...
// The TokenPartialRevocationSecretShareFunc type is an adapter to allow the use of ordinary function as a Querier.
type TokenPartialRevocationSecretShareFunc func(context.Context, *ent.TokenPartialRevocationSecretShareQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f TokenPartialRevocationSecretShareFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.TokenPartialRevocationSecretShareQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.TokenPartialRevocationSecretShareQuery", q)
}

// The TraverseTokenPartialRevocationSecretShare type is an adapter to allow the use of ordinary function as Traverser.
type TraverseTokenPartialRevocationSecretShare func(context.Context, *ent.TokenPartialRevocationSecretShareQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseTokenPartialRevocationSecretShare) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseTokenPartialRevocationSecretShare) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.TokenPartialRevocationSecretShareQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.TokenPartialRevocationSecretShareQuery", q)
}
...
// The TokenTransactionPeerSignatureFunc type is an adapter to allow the use of ordinary function as a Querier.
type TokenTransactionPeerSignatureFunc func(context.Context, *ent.TokenTransactionPeerSignatureQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f TokenTransactionPeerSignatureFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.TokenTransactionPeerSignatureQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.TokenTransactionPeerSignatureQuery", q)
}

// The TraverseTokenTransactionPeerSignature type is an adapter to allow the use of ordinary function as Traverser.
type TraverseTokenTransactionPeerSignature func(context.Context, *ent.TokenTransactionPeerSignatureQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseTokenTransactionPeerSignature) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseTokenTransactionPeerSignature) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.TokenTransactionPeerSignatureQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.TokenTransactionPeerSignatureQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.TokenPartialRevocationSecretShareQuery:
		return &query[*ent.TokenPartialRevocationSecretShareQuery, predicate.TokenPartialRevocationSecretShare, tokenpartialrevocationsecretshare.OrderOption]{typ: ent.TypeTokenPartialRevocationSecretShare, tq: q}, nil
	...
	case *ent.TokenTransactionPeerSignatureQuery:
		return &query[*ent.TokenTransactionPeerSignatureQuery, predicate.TokenTransactionPeerSignature, tokentransactionpeersignature.OrderOption]{typ: ent.TypeTokenTransactionPeerSignature, tq: q}, nil
