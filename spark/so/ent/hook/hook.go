...
// Mutate calls f(ctx, m).
func (f EntityDkgKeyFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.EntityDkgKeyMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f L1TokenCreateFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.L1TokenCreateMutation); ok {
		return f(ctx, mv)
	}
...
// The SparkInvoiceFunc type is an adapter to allow the use of ordinary
// function as SparkInvoice mutator.
type SparkInvoiceFunc func(context.Context, *ent.SparkInvoiceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SparkInvoiceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SparkInvoiceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SparkInvoiceMutation", m)
}
...
// The TokenPartialRevocationSecretShareFunc type is an adapter to allow the use of ordinary
// function as TokenPartialRevocationSecretShare mutator.
type TokenPartialRevocationSecretShareFunc func(context.Context, *ent.TokenPartialRevocationSecretShareMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TokenPartialRevocationSecretShareFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TokenPartialRevocationSecretShareMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TokenPartialRevocationSecretShareMutation", m)
}
...
// The TokenTransactionPeerSignatureFunc type is an adapter to allow the use of ordinary
// function as TokenTransactionPeerSignature mutator.
type TokenTransactionPeerSignatureFunc func(context.Context, *ent.TokenTransactionPeerSignatureMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TokenTransactionPeerSignatureFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TokenTransactionPeerSignatureMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TokenTransactionPeerSignatureMutation", m)
}
