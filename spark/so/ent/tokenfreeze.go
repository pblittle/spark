...
type TokenFreeze struct {
	...
	Edges        TokenFreezeEdges `json:"edges"`
	selectValues sql.SelectValues
}

// TokenFreezeEdges holds the relations/edges for other nodes in the graph.
type TokenFreezeEdges struct {
	// Token create contains the token metadata associated with this token freeze.
...
func (e TokenFreezeEdges) TokenCreateOrErr() (*TokenCreate, error) {
...
func (*TokenFreeze) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case tokenfreeze.FieldID, tokenfreeze.FieldTokenCreateID:
...
// QueryTokenCreate queries the "token_create" edge of the TokenFreeze entity.
func (tf *TokenFreeze) QueryTokenCreate() *TokenCreateQuery {
	return NewTokenFreezeClient(tf.config).QueryTokenCreate(tf)
}
...
func (tf *TokenFreeze) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", tf.TokenCreateID))
	builder.WriteByte(')')
