...
const (
	GossipService_Gossip_FullMethodName = "/gossip.GossipService/gossip"
)
...
type GossipServiceClient interface {
	Gossip(ctx context.Context, in *GossipMessage, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *gossipServiceClient) Gossip(ctx context.Context, in *GossipMessage, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type GossipServiceServer interface {
	Gossip(context.Context, *GossipMessage) (*emptypb.Empty, error)
...
func (UnimplementedGossipServiceServer) Gossip(context.Context, *GossipMessage) (*emptypb.Empty, error) {
