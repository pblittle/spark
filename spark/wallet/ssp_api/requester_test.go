...
func TestExecuteGraphqlWithContext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := requester.ExecuteGraphqlWithContext(context.Background(), tt.query, tt.variables)
...
func TestExecuteGraphqlWithContext_Errors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, err := requester.ExecuteGraphqlWithContext(context.Background(), tt.query, nil)
...
func TestExecuteGraphqlWithContext_DecompressionErrors(t *testing.T) {
	...
	result, err := requester.ExecuteGraphqlWithContext(context.Background(), query, nil)
