...
type QueryTokenTransactionsParams struct {
	IssuerPublicKeys  []SerializedPublicKey
...
func QueryTokenOutputsV2(
	...
	request := &tokenpb.QueryTokenOutputsRequest{
		OwnerPublicKeys:  toByteSlices(ownerPublicKeys),
		IssuerPublicKeys: toByteSlices(tokenPublicKeys), // Field name change: TokenPublicKeys -> IssuerPublicKeys
...
func QueryTokenTransactionsV2(
	...
	request := &tokenpb.QueryTokenTransactionsRequest{
		OwnerPublicKeys:        toByteSlices(params.OwnerPublicKeys),
		IssuerPublicKeys:       toByteSlices(params.IssuerPublicKeys), // Field name change: TokenPublicKeys -> IssuerPublicKeys
...
func QueryTokenMetadata(
	...
	request := &tokenpb.QueryTokenMetadataRequest{
		...
		IssuerPublicKeys: toByteSlices(issuerPublicKeys),
	}
