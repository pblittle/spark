...
func VerifyPendingTransfer(_ context.Context, config *Config, transfer *pb.Transfer) (map[string][]byte, error) {
...
func prepareRefundSoSigningJobs(
	...
	for _, leaf := range leaves {
		...
		_, cpfpRefundTx, err := createRefundTxs(nextSequence, &nodeOutPoint, amountSats, receivingPubkey, true)
		if err != nil {
